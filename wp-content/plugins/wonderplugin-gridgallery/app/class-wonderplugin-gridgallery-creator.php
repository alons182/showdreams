					...
					<div class="wonderplugin-gridgallery-options-tabs" id="wonderplugin-gridgallery-options-tabs">
						...
						<div class="wonderplugin-gridgallery-options-tab wonderplugin-gridgallery-options-tab-selected">
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									<th>Text</th>
									<td><label><input name='wonderplugin-gridgallery-showtitle' type='checkbox' id='wonderplugin-gridgallery-showtitle'  /> Show text&nbsp;&nbsp;</label>
									<label>
									...
									<br><label><input name='wonderplugin-gridgallery-showtexttitle' type='checkbox' id='wonderplugin-gridgallery-showtexttitle'  /> Include title in text</label>
